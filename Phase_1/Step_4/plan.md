# 08 December 2025
- now that i got the candidate i will do a listening test
- and pray to god i will get it
- after going through the candidates completely (whatever the result maybe) , document all the code written so far
- if it's fails , don't worry we will go to next phase
